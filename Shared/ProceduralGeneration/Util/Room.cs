...
namespace Shared.ProceduralGeneration.Util
{
    public class Room
    {
        ...
        public Room(int width, int height, int x, int y, bool mustBeAtEdge = false, Texture texture = default)
        {
            ...
            if (texture != default)
                ...
                Texture = new Texture("Ground", System.Drawing.Color.FromArgb(HouseGenerator.Random.Next(255), HouseGenerator.Random.Next(255), HouseGenerator.Random.Next(255)));
        }

        public Room(int area, float noSquareness, bool mustBeAtEdge = false, Texture texture = default)
        {
            if (noSquareness <= 0)
                noSquareness = 0.01f;
        ...
        public Room(List<(int, int)> points, Texture texture = default)
        {
            this.points = points;
